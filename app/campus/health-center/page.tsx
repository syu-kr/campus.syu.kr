    ...
    <Container className="py-6 sm:py-8">
      ...
      <Card className="mb-6 border border-neutral-200 bg-white" hover={false}>
        ...
        <div className="space-y-4">
          ...
          <div>
            <p className="font-semibold text-neutral-900">{text.phone}</p>
            <a
              href="tel:0233993182"
      ...
      <Card
        className="mb-6 border border-red-200 bg-red-50/70"
        hover={false}
      >
        ...
        <div className="grid grid-cols-4 gap-4">
          {text.processSteps.map((step) => (
            <div key={step.num} className="text-center">
              <div className="mx-auto mb-2 flex h-12 w-12 items-center justify-center rounded-full bg-primary-600 text-lg font-bold text-white">
                {step.num}
              </div>
