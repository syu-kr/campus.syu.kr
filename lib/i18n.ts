  ...
  ko: {
    ...
    pages: {
      ...
      timetable: {
        ...
        enterCompareMode: "여러 시간표 짜기",
        leaveCompareMode: "단일 시간표 보기",
        compareTimetables: "시간표 비교",
        compareTimetablesDescription:
          "최대 4개의 시간표를 나란히 구성하고 비교하세요.",
        compareDesktopOnly:
          "다중 시간표 편집은 데스크톱에서 사용할 수 있습니다. 현재 편집 중인 시간표만 표시합니다.",
        timetable: "시간표",
        addTimetable: "시간표 추가",
        editing: "편집 중",
        editTimetable: "편집",
  ...
  en: {
    ...
    pages: {
      ...
      timetable: {
        ...
        enterCompareMode: "Build Multiple Timetables",
        leaveCompareMode: "View Single Timetable",
        compareTimetables: "Compare Timetables",
        compareTimetablesDescription:
          "Build and compare up to four timetable alternatives side by side.",
        compareDesktopOnly:
          "Multiple timetable editing is available on desktop. Only the active timetable is shown here.",
        timetable: "Timetable",
