  ...
  ko: {
    ...
    academic: {
      ...
      menus: {
        ...
        swNoticesTitle: "SW중심대학 공지",
        swNoticesDescription: "SW·AI 교육, 장학금 및 프로그램 안내",
    ...
    pages: {
      ...
      announcements: {
        allTitle: "전체 공지",
        allDescription:
          "학사공지, 캠퍼스공지, 장학금, SW중심대학 공지를 최신순으로 확인하세요",
        ...
        swTitle: "SW중심대학 공지",
        swDescription: "SW·AI 교육, 장학금 및 프로그램 공지를 확인하세요",
        swError:
      ...
      timetable: {
        ...
        draftAutoSaveNotice:
          "직접 구성한 시간표는 이 브라우저에 30일간 자동 저장됩니다.",
        ...
        enterCompareMode: "여러 시간표로",
        leaveCompareMode: "하나의 시간표로",
        compareTimetables: "여러 시간표",
        compareTimetablesDescription:
          "최대 4개를 나란히 비교하고 강의를 넣을 시간표를 선택하세요. 세로 스크롤은 함께 움직입니다.",
        compareDesktopOnly:
          "여러 시간표 기능은 데스크톱에서 사용할 수 있습니다. 여기서는 선택한 시간표만 표시합니다.",
        timetable: "시간표",
        addTimetable: "시간표 추가",
        editing: "선택됨",
        editTimetable: "선택",
        duplicate: "복제",
        duplicateTimetable: "복제",
        deleteTimetable: "삭제",
        addToTimetable: "추가할 시간표",
        removeFromTimetable: "시간표에서 제거",
        addCourse: "강의 추가",
        desktopPanelLabel: "시간표 선택 도구",
        courseFilter: "과목 필터",
        searchPlaceholder: "과목명, 교수, 코드, 영역, 비고",
        searchMatchedIn: "검색 일치",
        classDay: "수업 요일",
        classDayDescription:
          "선택한 요일 중 하나라도 수업이 있는 강의를 표시합니다.",
        classPeriod: "수업 교시",
        startPeriod: "시작",
        endPeriod: "종료",
        anyPeriod: "전체",
  ...
  en: {
    ...
    home: {
      ...
      notices: {
        ...
        swAll: "All SW-centered university notices",
    ...
    academic: {
      ...
      menus: {
        ...
        swNoticesTitle: "SW-Centered University Notices",
        swNoticesDescription:
          "SW and AI education, scholarships, and program updates",
    ...
    categories: {
      ...
      swAnnouncement: "SW-Centered University Notices",
      scholarship: "Scholarships",
    ...
    pages: {
      ...
      announcements: {
        ...
        allDescription:
          "Browse academic, campus, scholarship, and SW-centered university notices by newest first",
        ...
        swTitle: "SW-Centered University Notices",
        swDescription:
          "Check SW and AI education, scholarship, and program notices",
        swError:
      ...
      timetable: {
        ...
        draftAutoSaveNotice:
          "Timetables you build are saved in this browser for 30 days.",
        draftStorageUnavailable:
        ...
        enterCompareMode: "Use Multiple Timetables",
        leaveCompareMode: "Use One Timetable",
        compareTimetables: "Multiple Timetables",
        compareTimetablesDescription:
          "Compare up to four timetables and select where to add courses. Vertical scrolling stays synchronized.",
        compareDesktopOnly:
          "Multiple timetables are available on desktop. Only the selected timetable is shown here.",
        timetable: "Timetable",
        addTimetable: "Add Timetable",
        editing: "Selected",
        editTimetable: "Select",
        duplicate: "Duplicate",
        duplicateTimetable: "Duplicate timetable",
        deleteTimetable: "Delete timetable",
        addToTimetable: "Add to timetable",
        removeFromTimetable: "Remove from timetable",
        addCourse: "Add Course",
        desktopPanelLabel: "Timetable selection tools",
        courseFilter: "Course Filter",
        searchPlaceholder: "Course, professor, code, area, or note",
        searchMatchedIn: "Matched in",
        classDay: "Class days",
        classDayDescription:
          "Shows courses that meet on at least one selected day.",
