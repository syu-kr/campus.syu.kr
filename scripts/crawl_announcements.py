        ...
        try:
            with open(data_path, 'r', encoding='utf-8') as f:
                ...
                if existing_announcements:
                    latest_title = existing_announcements[0]['title']
            ...
            try:
                ...
                for row in table_rows:
                    ...
                    try:
                        ...
                        author_text = row.select_one("td:nth-of-type(3)").get_text(strip=True) if row.select_one("td:nth-of-type(3)") else ""
                        date_text = row.select_one("td:nth-of-type(4)").get_text(strip=True) if row.select_one("td:nth-of-type(4)") else ""
                        ...
                        if title:
                            new_announcements.append({
                                "id": f"academic-{datetime.now().timestamp()}-{str(uuid.uuid4())[:8]}",
                                "title": clean_title,
